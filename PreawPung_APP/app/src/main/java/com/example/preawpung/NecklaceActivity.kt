...
import com.example.preawpung.databinding.ActivityNecklaceBinding
...
class NecklaceActivity : AppCompatActivity() {

    private lateinit var binding: ActivityNecklaceBinding
    private var productList = arrayListOf<Product>()

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityNecklaceBinding.inflate(layoutInflater)
